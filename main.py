...
def get_args_parser():
    ...
    # * Backbone
    parser.add_argument('--cfg', type=str, default='configs/dat_tiny.yaml', metavar="FILE",
                        help='path to config file', )
    parser.add_argument('--backbone', default='dat_tiny', type=str,
    ...
    # HOI
    parser.add_argument('--pretrained', type=str, default="param/dat_tiny.pth",
    ...
    parser.add_argument('--coco_path', default='/home/msl/coco2014/', type=str)
    parser.add_argument('--coco_panoptic_path', type=str)
    parser.add_argument('--remove_difficult', action='store_true')
    parser.add_argument('--hoi_path', default='/mnt/gluster/ssd/datasets/v-coco', type=str)
...
def main(args, config):
    ...
    model, criterion, postprocessors = build_model(args, config)
    model.to(device)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            if (epoch + 1) % args.lr_drop == 0 or (epoch + 1) % 100 == 0 or epoch > 119 or epoch >= 0:
